...
def audio_to_text():
    ...
    st.info("Listening... Speak into your microphone now.")
...
if st.button("Start Speaking"):
    ...
    st.write("chart type:", charttype)

    if speech_text != "No speech recognized. Please try again." and speech_text != "An unexpected error occurred.":
